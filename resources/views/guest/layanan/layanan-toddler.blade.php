        ...
        <div class="detail-container">
            ...
            <div class="section-title-wrapper">
                <h2 class="section-title">
                    Layanan <span class="subtitle-span">Toddler</span>
                </h2>
            </div>

            {{-- GRID --}}
            <div class="layanan-grid">
                @forelse ($todlerProducts as $product)
                    <div class="layanan-card">
                        ...
                        <div class="layanan-content">
                            <h3>{{ $product->name }}</h3>
                            <p class="harga">Rp {{ number_format($product->sale_price, 0, ',', '.') }}</p>
                ...
                @empty
                    <div
                        style="grid-column: 1 / -1; text-align: center; padding: 50px; color: #888; font-family: 'nunito', sans-serif;">

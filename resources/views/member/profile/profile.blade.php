@extends('member.layouts.app')
    <style>
        /* --- Global Setup --- */
        body {
            background-color: #FFFDEB; /* Cream Background */
        ...
        /* --- 1. CARD HEADER (PINK) --- */
        .profile-header-card {
            background-color: #ffdad1; /* Pink Salem */
            border-radius: 20px;
            padding: 30px;
        ...
        .stat-box {
            background-color: #e0e0e0; /* Abu-abu sesuai gambar */
            border-radius: 12px;
            padding: 10px 20px;
            text-align: center;
            min-width: 100px;

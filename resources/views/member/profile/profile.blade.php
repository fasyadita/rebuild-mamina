...
<style>
    ...
    * {
    ...
    .profile-container {
        max-width: 1100px;
        margin: 140px auto 60px; /* Tambahkan margin bawah agar tidak mentok */
        padding: 0 20px;
    }
    ...
    .btn-reset-pass {
        ...
        display: inline-block; /* Agar margin bisa bekerja sempurna */
    }
    ...
    .data-header {
        ...
        padding-bottom: 15px;
        flex-wrap: wrap; /* Menjaga agar tombol tidak keluar jalur di HP */
        gap: 10px;
    }
    ...
    .data-value {
        ...
        font-weight: 500;
        margin-bottom: 20px;
        word-wrap: break-word; /* Mencegah email panjang merusak layout grid */
    ...
    @media (max-width: 768px) {
        .profile-container {
            margin-top: 100px; /* Kurangi jarak atas di HP */
        }
        ...
        .stats-container {
            justify-content: center; /* Menengahkan kotak Point dan Level di HP */
            width: 100%;
        }
        ...
        .data-header {
            flex-direction: column; /* Menyusun Judul dan Tombol Edit Profil ke bawah */
            align-items: flex-start;
        }

        .data-value {
            font-size: 14px; /* Teks sedikit dikecilkan di HP */
        }
    }
</style>

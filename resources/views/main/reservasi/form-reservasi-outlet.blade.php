...
@section('content')
    ...
    <style>
        ...
        .card-panel {
            background-color: #CFF3EB; /* Hijau Mint */
            border-radius: 20px;
            padding: 30px;
        ...
        .custom-input, .custom-select {
            width: 100%;
            padding: 12px 20px;
            border-radius: 50px; /* Membuat input bulat lonjong */
            border: none;
            outline: none;
            font-size: 14px;
            color: #555;
        ...
        textarea.custom-input {
            border-radius: 20px; /* Sudut lebih kotak untuk area teks */
            resize: vertical;
            height: 120px;
        }
        ...
        @media (max-width: 768px) {
            .main-layout {
                grid-template-columns: 1fr; /* Menjadi 1 kolom ke bawah */
            }
            
            /* Ubah urutan jika ingin price summary di atas form pada HP */
            /* .sidebar { order: -1; } */
        }
    </style>

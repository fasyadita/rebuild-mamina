...
<section class="faq py-10 px-5 relative" id="faq-section">
    <div class="max-w-6xl mx-auto">
        ...
        {{-- FAQ Grid --}}
        <div class="grid md:grid-cols-2 gap-3 items-start font-nunito">

            {{-- FAQ Item 1 (Baby Spa bisa untuk usia berapa? - Active/Open by default) --}}
            <div class="faq-item bg-[#DDE8E2] rounded-lg shadow-sm p-4 transition-all duration-300 cursor-pointer border border-transparent hover:border-[#BBCDCE]" data-active="true">
                <div class="flex justify-between items-start gap-2">
                    <div class="flex-grow">
                        <h3 class="text-base font-medium text-[#222] mb-2 faq-question transition-all duration-300">
                        ...
                        <div class="faq-answer-wrapper overflow-hidden transition-all duration-300" style="max-height: 200px; opacity: 1;">
                            <p class="text-[#4A4A4A] leading-relaxed text-xs">
                    ...
                    <button class="text-xl text-[#2F2F2F] font-light focus:outline-none faq-btn w-6 h-6 flex items-center justify-center rounded-full hover:bg-white/30 transition duration-300 flex-shrink-0">
                        -
                    </button>
                </div>
            </div>
            ...
            <div class="faq-item bg-[#DDE8E2] rounded-lg shadow-sm p-4 transition-all duration-300 cursor-pointer border border-transparent hover:border-[#BBCDCE]" data-active="false">
                <div class="flex justify-between items-start gap-2">
                    <div class="flex-grow">
                        <h3 class="text-base font-medium text-[#222] faq-question transition-all duration-300">
                        ...
                        <div class="faq-answer-wrapper overflow-hidden transition-all duration-300" style="max-height: 0px; opacity: 0;">
                            <p class="text-[#4A4A4A] leading-relaxed text-xs mt-2">
            ...
            <div class="faq-item bg-[#DDE8E2] rounded-lg shadow-sm p-4 transition-all duration-300 cursor-pointer border border-transparent hover:border-[#BBCDCE]" data-active="false">
                <div class="flex justify-between items-start gap-2">
                    <div class="flex-grow">
                        ...
                        <div class="faq-answer-wrapper overflow-hidden transition-all duration-300" style="max-height: 0px; opacity: 0;">
                            <p class="text-[#7A7A7A] leading-relaxed text-xs mt-2">
                    ...
                    <button class="text-xl text-[#7A7A7A] font-light focus:outline-none faq-btn w-6 h-6 flex items-center justify-center rounded-full hover:bg-white/30 transition duration-300 flex-shrink-0">
                        +
                    </button>
                </div>
            </div>
        ...
        <div class="flex justify-center mt-7">
            <button id="btn-lihat-semua"
                class="bg-[#5AA6A5] hover:bg-[#4B9493] text-white px-5 py-2 rounded-full text-sm font-semibold transition duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5">
